...
import selectGenerator from "../selectComponent/selectComponent";
import inputGenerator from "../inputComponent/inputComponent";
import labelGenerator from "../labelComponent/labelComponent";
...
function formInsurance() {
  ...
  function showResult() {
    ...
    silverBox({
      customIcon:
        "https://images.vexels.com/media/users/3/135880/isolated/preview/aed603eafeda47aaca93b292db4a9141-electric-car-circle-icon.png",
      title: {
        text:
          insuranceType == "third"
